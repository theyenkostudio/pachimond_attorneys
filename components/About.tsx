        ...
        <div className="lg:grid lg:grid-cols-[1.1fr_1fr] lg:gap-28 xl:gap-36 items-start">
          ...
          <div ref={imageRef} className="relative">
            ...
            <motion.div
              ...
              transition={{ duration: 0.75, delay: 1.05, ease: [0.215, 0.61, 0.355, 1] }}
            >
          ...
          <div className="mt-16 lg:mt-20 pb-10">
            ...
            {/* Body copy */}
            <motion.p
              className="text-gray-500 leading-relaxed max-w-md font-sans-ui text-base"
              initial={{ opacity: 0, y: 14 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true, margin: '-60px' }}
              transition={{ duration: 0.8, delay: 0.55, ease: 'easeOut' }}
            >
              At Pachimond Attorneys, we know that behind every case is a story that
              matters. We combine sharp legal strategy with a client-first approach,
              ensuring you feel supported, informed, and fiercely represented at every step.
            </motion.p>
          </div>
        </div>
      </div>
